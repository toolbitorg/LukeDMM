// -*- C++ -*-
//
// generated by wxGlade 0.7.2 on Sun Jan 29 12:28:02 2017
//
...
#ifndef LUKE_DMM_WX_H
#define LUKE_DMM_WX_H
...
protected:
    ...
    wxTextCtrl* text_ctrl_unit;
    wxRadioBox* radio_box_mode;
    // end wxGlade

    DECLARE_EVENT_TABLE();

public:
//    virtual void onRadiobox(wxCommandEvent &event); // wxGlade: <event_handler>
}; // wxGlade: end class
